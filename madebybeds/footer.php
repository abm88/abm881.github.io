                ...
                <ul class="list-unstyled clear-margins"><!-- widgets -->
                        	...
                        	<li class="widget-container widget_nav_menu"><!-- widgets list -->
                                ...
                                <ul>
                                    ...
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Distance Coaching</a></li>
                                    <li><a  href="#"><i class="fa fa-angle-double-right"></i>  Liberary</a></li>
                ...
                <div class="col-lg-3 col-md-3"><!-- widgets column center -->
                        ...
                        <ul class="list-unstyled clear-margins"><!-- widgets -->
                        	...
                        	<li class="widget-container widget_recent_news"><!-- widgets list -->
                                ...
                                <h1 class="title-widget">Follow </h1>
                                
                                <div class="footerp"> 
                                
                                <h2 class="title-median">Made By Beds</h2>
                                <p><b>Email id:</b> <a href="mailto:abdul.basith@study.beds.ac.uk">abdul.basith@study.beds.ac.uk</a></p>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
				...
				<div class="copyright">
					...
					© 2016, University of Befordshire, All rights reserved
			...
			<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
				...
				<div class="design">
					 ...
					 <a target="_blank" href="http://www.opacks.com">Web Design & Development by Abdul Basith</a>
